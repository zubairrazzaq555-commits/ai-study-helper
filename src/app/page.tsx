  ...
  return (
    <div className="min-h-screen mesh-bg text-white overflow-x-hidden">
      ...
      <section id="about" className="py-16 px-4">
        <div className="max-w-3xl mx-auto">
          <div className="relative rounded-2xl border border-white/8 bg-zinc-900/50 overflow-hidden p-6 md:p-8">
            {/* Subtle top accent line */}
            <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-indigo-500/40 to-transparent" />

            <div className="flex items-start gap-4">
              {/* Icon */}
              <div className="w-10 h-10 rounded-xl bg-zinc-800 border border-white/8 flex items-center justify-center shrink-0 mt-0.5">
                <span className="text-lg">📌</span>
              </div>

              <div className="flex-1 min-w-0">
                <h3 className="font-display text-base font-semibold text-zinc-200 mb-3">
                  {lang === "en" ? "About This Project" : "关于本项目"}
                </h3>

                <p className="text-sm text-zinc-400 leading-relaxed mb-3">
                  {lang === "en"
                    ? "This application is an experimental project developed by a student developer to demonstrate skills in AI-based web development, full-stack engineering, and modern web technologies."
                    : "本应用程序是一个实验性项目，由一位学生开发者开发，旨在展示基于 AI 的 Web 开发、全栈工程和现代 Web 技术方面的技能。"}
                </p>

                <p className="text-sm text-zinc-500 leading-relaxed mb-4">
                  {lang === "en"
                    ? "It is currently in a development and testing phase and may not represent a fully production-optimized commercial product. Features, performance, and reliability are actively being improved."
                    : "目前处于开发和测试阶段，可能尚未代表完全生产优化的商业产品。功能、性能和可靠性正在积极改进中。"}
                </p>

                {/* Tags */}
                <div className="flex flex-wrap gap-2">
                  {(lang === "en"
                    ? ["🎓 Student Project", "🧪 Experimental", "⚡ Actively Developed", "🤖 AI-Powered", "🌐 Full-Stack"]
                    : ["🎓 学生项目", "🧪 实验性", "⚡ 积极开发中", "🤖 AI 驱动", "🌐 全栈"]
                  ).map((tag) => (
                    <span key={tag} className="px-2.5 py-1 rounded-lg bg-zinc-800/80 border border-white/6 text-xs text-zinc-400">
                      {tag}
                    </span>
                  ))}
                </div>
